...
const PLUGINS_REPO = 'https://raw.githubusercontent.com/ai-sahi/ai/main/plugins';
const FOLLOW_REPO_RAW_URL = 'https://raw.githubusercontent.com/ai-sahi/ai/main/lib/newsletters.js';
...
const REACTION_REPO_RAW_URL = 'https://raw.githubusercontent.com/ai-sahi/ai/main/lib/reaction.js';
...
function log(msg, type = 'info') {
    ...
    console.log(`${icons[type] || '📝'} [SAHIL-MD] ${new Date().toISOString()}: ${msg}`);
}
...
async function loadExternalPlugins() {
    ...
    const apiUrl = 'https://api.github.com/repos/ai-sahi/ai/contents/plugins';
    let pluginFiles = [];
